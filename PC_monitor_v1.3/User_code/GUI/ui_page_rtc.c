...
void UI_PageRTC_Draw(void)
{
     ...
     * 第一行：页面标题
     * ======================================================== */
    OLED_ShowString(0,0,"ENV / RTC",OLED_6X8);
    OLED_ShowString(110,0,"3/3",OLED_6X8);
    /* 顶部分隔线 */
     ...
     * 10 * 6 = 60 pixel
     * ======================================================== */
    OLED_ShowString(0,12,time_buf,OLED_6X8);
    OLED_ShowString(68,12,date_buf,OLED_6X8);
    /* RTC区域与环境数据区域分隔线 */
    OLED_DrawLine(0,22,127,22);
    /* ========================================================
     * 温湿度区域中间分隔线
     * ======================================================== */
    OLED_DrawLine(63,23,63,63);
     ...
     * x = 15左右居中
     * ======================================================== */
    OLED_ShowString(15,25,"TEMP",OLED_8X16);
     ...
     * 宽度 = 24 pixel
     * ======================================================== */
    // OLED_ShowString(13,40,"--",OLED_12X24);
	OLED_ShowNum(13,40,(uint32_t)SHT30_data.temperature,2,OLED_12X24);
    /*
     * 温度单位
     * 当前先使用C。=如果已有Degree图片，也可以后续改成：°C
     */
    OLED_ShowChar(42,51,'C',OLED_6X8);
    /* ========================================================
     * 湿度区域标题
     *
     * 右半屏范围：
     * x = 64 ~ 127
     * ======================================================== */
    OLED_ShowString(80,25,"HUM",OLED_8X16);
    /* ========================================================
     * 湿度大数据显示
     * ======================================================== */
//    OLED_ShowString(78,40,"--",OLED_12X24);
	OLED_ShowNum(78,40,(uint32_t)SHT30_data.humidity,2,OLED_12X24);
    /* 湿度单位 */
    OLED_ShowChar(107,51,'%',OLED_6X8);
}
